...
class FaissVectorStore:
    ...
    def __init__(self, node_id: str, dimension: int = 384, 
        ...
        self.vector_ids_set = set(self.vector_ids)  # O(1) duplicate checks
    ...
    def save(self, text: str, embedding: np.ndarray, 
        ...
        # BOLT OPTIMIZATION: Use in-memory set for O(1) duplicate check (was O(N) list check)
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = 5) -> List[Dict]:
        ...
        # BOLT OPTIMIZATION: Batched metadata retrieval to avoid N individual SQL queries
