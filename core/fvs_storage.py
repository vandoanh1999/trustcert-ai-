...
class FaissVectorStore:
    ...
    def __init__(self, node_id: str, dimension: int = 384, 
        ...
        # Vector ID mapping (Set for O(1) duplicate checks)
    ...
    @property
    def vector_ids(self):
        """Compatibility property for vector_ids"""
    ...
    def save(self, text: str, embedding: np.ndarray, 
        ...
        # BOLT OPTIMIZATION: O(1) duplicate check using a set
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = 5) -> List[Dict]:
        ...
        # BOLT OPTIMIZATION: Batched SQL query to resolve N+1 query problem
        # Fetch all metadata in a single call instead of O(K) separate queries
