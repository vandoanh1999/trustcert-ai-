...
class FaissVectorStore:
    ...
    def __init__(self, node_id: str, dimension: int = 384, 
        ...
        # BOLT OPTIMIZATION: Use a set for O(1) duplicate checks during save
    ...
    def save(self, text: str, embedding: np.ndarray, 
        ...
        # BOLT OPTIMIZATION: O(1) check using set instead of O(N) list scan
    ...
    def search(self, query_embedding: np.ndarray, top_k: int = 5) -> List[Dict]:
        ...
        # This avoids N separate database roundtrips, significantly improving search latency.
        ...
        # Create a mapping from idx to row for efficient re-ordering
