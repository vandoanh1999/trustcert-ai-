...
EXPERT_MAP = {
    ...
    "dummy_adapters/expert_C/adapter_model.bin": "Technical Analyst (Expert C)"
}
...
selected_experts = st.multiselect(
    ...
    help="In a production system, the Oracle Brain automatically selects the best experts for your query."
)
