...
user_instruction = st.text_area(
    ...
    placeholder="e.g., How does the P2P gossip network achieve consensus?",
    help="Describe what you want the Genesis expert network to do or answer."
)
...
if st.session_state.last_response:
    ...
    feedback_score = st.slider(
        ...
        0.0, 1.0, 0.75, 0.05,
        help="Your feedback helps improve the expert network's reputation."
    )

    if st.button(
        "Submit Feedback",
        type="primary",
        help="Send your rating to the Aurora Trust Engine."
    ):
