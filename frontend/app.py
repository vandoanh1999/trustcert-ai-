...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Explain the causal relationship between solar flares and power grid stability.",
    help="Provide a clear and detailed instruction for the expert network to process.",
    max_chars=1000
)
...
if st.button("✨ Query Genesis", type="primary", disabled=not user_instruction or not selected_experts):
    with st.spinner("Dispatching query to the expert network..."):
        ...
        if dispatch_id and response_text:
            ...
            st.toast("Query successfully dispatched!")
