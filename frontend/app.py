...
selected_experts = st.multiselect(
    ...
    help="Choose specialized expert nodes to process your request. Different experts excel at different tasks."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze this dataset for anomalies' or 'Draft a security audit report'",
    help="Provide clear, concise instructions for the expert network."
)
