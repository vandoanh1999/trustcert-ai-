...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Give time for the toast to be seen
            st.rerun()
        else:
...
selected_experts = st.multiselect(
    ...
    help="Experts specialize in different fields. Research Assistant is best for general info, Data Analyst for numbers, and Security Auditor for code/safety."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Explain the importance of decentralized consensus in 3 bullet points.",
    help="Be as specific as possible to get the best result from the expert network."
)
