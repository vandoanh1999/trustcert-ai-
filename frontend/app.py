...
selected_experts = st.multiselect(
    ...
    help="Choose which specialized AI experts you want to consult for this query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Analyze the impact of decentralized P2P networks on AI inference latency.",
    max_chars=1000,
    help="Describe what you want Genesis to do. Be as specific as possible for better results."
)

if st.button(
    "✨ Query Genesis",
    disabled=not user_instruction or not selected_experts,
    help="Click to dispatch your query to the expert network. Requires experts to be selected and a question to be entered."
):
