...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Explain the P-RAG routing mechanism or summarize the network health."
)

if st.button(
    "✨ Query Genesis",
    disabled=not user_instruction or not selected_experts,
    help="Enter an instruction and select at least one expert to enable querying."
):
