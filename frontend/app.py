...
user_instruction = st.text_area("Enter your instruction or question:", placeholder="e.g., How does the P2P gossip protocol work in Genesis?")

button_help = "Please enter an instruction and select at least one expert." if not user_instruction or not selected_experts else "✨ Query the Genesis expert network"
