...
selected_experts = st.multiselect(
    ...
    help="Select which specialized AI models should process your request."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Explain the concept of P2P gossip networks in 3 sentences.",
    help="Provide a clear instruction or question for the Genesis ecosystem."
)
