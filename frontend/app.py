...
selected_experts = st.multiselect(
    ...
    help="Choose one or more specialized AI agents to help with your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Summarize recent research on sustainable energy' or 'Audit this smart contract for vulnerabilities'...",
    help="Describe your task in detail. Tip: Press Ctrl+Enter to sync your input."
)

if st.button("✨ Query Genesis",
             disabled=not user_instruction or not selected_experts,
             help="Select at least one expert and enter an instruction to begin."):
