...
selected_experts = st.multiselect(
    ...
    help="Choose which specialized AI experts will analyze your query. In a production environment, this is typically handled automatically by the Oracle Brain."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'What are the security implications of this decentralized consensus model?'",
    help="Be as descriptive as possible to get the best results from the expert network."
)
...
if st.button(
    ...
    help="Click to dispatch your query to the network. This button is disabled until you provide an instruction and select at least one expert."
):
