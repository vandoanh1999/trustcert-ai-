...
EXPERT_MAP = {
    ...
    "dummy_adapters/expert_B/adapter_model.bin": "Data Scientist (Expert B)",
    "dummy_adapters/expert_C/adapter_model.bin": "Technical Architect (Expert C)"
}
...
def query_genesis_backend(instruction, experts):
    ...
    try:
        ...
        friendly_experts = [EXPERT_MAP.get(e, e) for e in experts]
        mock_response_text = f"This is a simulated response for your query about '{instruction[:30]}...' using experts {', '.join(friendly_experts)}."
...
if st.button(
    ...
    help="Enter an instruction and select at least one expert to enable this button."
):
