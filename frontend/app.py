...
user_instruction = st.text_area(
    ...
    placeholder="e.g., 'Analyze the recent P2P gossip protocol performance' or 'How can I optimize my Super Node?'"
)

if st.button(
    "Query Genesis",
    disabled=not user_instruction or not selected_experts,
    help="Enter a query and select at least one expert to enable dispatching."
):
