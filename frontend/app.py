...
user_instruction = st.text_area("Enter your instruction or question:", placeholder="Ask anything to the Genesis network...")

# Guide the user if the button is disabled
query_help = "Enter an instruction and select at least one expert to enable." if not user_instruction or not selected_experts else "Send your query to the expert network."

if st.button("Query Genesis", disabled=not user_instruction or not selected_experts, use_container_width=True, help=query_help):
