...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.error(
                f"Failed to submit feedback. Server responded with: "
...
query_help = "Dispatch your request to the network."
...
if st.session_state.last_response:
    ...
    if st.button("Submit Feedback"):
        # This is a slight hack for the demo. Since the backend isn't tracking
        # our mocked dispatch IDs, we'll quickly register it before feedback.
        # This simulates the ID existence from the inference step.
        try:
            ...
            # Ignore if it fails, the main feedback call is the important one
            pass
