...
selected_experts = st.multiselect(
    ...
    help="Choose the specialized AI models that will collaborate to answer your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Explain the importance of decentralized AI in 3 bullet points.",
    help="Provide a clear and concise instruction for the Genesis network."
)
...
if st.session_state.last_response:
    ...
    feedback_score = st.slider("Rating (0.0 = Bad, 1.0 = Perfect)", 0.0, 1.0, 0.75, 0.05, help="Your rating helps the Aurora Engine calibrate expert reputation.")
    ...
    if st.button("Submit Feedback", type="primary"):
        ...
        success, error_msg = send_feedback_to_backend(response_data["dispatch_id"], feedback_score)
        if success:
            st.toast("Feedback submitted! Thank you for helping the network learn. 🚀")
            time.sleep(1)
            st.session_state.last_response = None
            st.rerun()
        else:
