...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Summarize the latest security audits or analyze this data trend."
)
...
if st.session_state.last_response:
    ...
    # Dynamic emoji feedback to improve user engagement
    if feedback_score < 0.3:
        rating_mood = "🔴 (Poor)"
    elif feedback_score < 0.7:
        rating_mood = "🟡 (Average)"
    else:
        rating_mood = "🟢 (Excellent)"
    st.write(f"Your rating: **{feedback_score}** {rating_mood}")
