...
def query_genesis_backend(instruction, experts):
    ...
    """
    expert_names = [EXPERT_MAP.get(e, e) for e in experts]
...
user_instruction = st.text_area("Enter your instruction or question:", placeholder="e.g., Explain the benefits of a symbiotic AI network...")

if st.button("🚀 Query Genesis", type="primary", disabled=not user_instruction or not selected_experts, help="Send your request to the decentralized expert pool"):
...
if st.session_state.last_response:
    ...
    with st.chat_message("assistant", avatar="🌌"):
        ...
        st.caption(f"**Experts consulted:** {', '.join([EXPERT_MAP.get(e, e) for e in response_data['experts']])}")
