...
selected_experts = st.multiselect(
    ...
    help="Experts are specialized models that will collaborate to answer your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze the security implications of the new consensus protocol.'",
    help="Provide a clear instruction or question for the expert network to process."
)
