...
selected_experts = st.multiselect(
    ...
    help="Choose one or more AI experts to handle your request. Each expert has a specific domain of knowledge."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    key="user_instruction",
    placeholder="e.g., Explain the importance of hardware-based identity in decentralized networks.",
    help="Type your query here. The Genesis expert network will process it and provide a response."
)
...
with col_btn1:
    query_btn = st.button(
        ...
        help="Submit your query to the decentralized expert network."
    )
...
with col_btn2:
    st.button(
        ...
        on_click=reset_ui,
        use_container_width=True,
        help="Reset the interface and start a new query."
    )
