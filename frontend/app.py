...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Ensure toast is visible before rerun
            st.rerun()
        else:
...
user_instruction = st.text_area(
    ...
    placeholder="e.g., 'Analyze the security implications of decentralized P2P networks'",
    help="Provide clear instructions for the expert network to process."
)
