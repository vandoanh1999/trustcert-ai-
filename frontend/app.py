...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Summarize the latest P2P gossip protocol optimizations...",
    help="Provide a clear instruction or question for the Genesis expert network."
)

if st.button("Query Genesis", type="primary", disabled=not user_instruction or not selected_experts, help="Dispatch your query to the network."):
...
if st.session_state.last_response:
    ...
    if feedback_score < 0.2: sentiment_label = "🔴 Poor"
    elif feedback_score < 0.4: sentiment_label = "🟠 Subpar"
    elif feedback_score < 0.6: sentiment_label = "🟡 Average"
    elif feedback_score < 0.8: sentiment_label = "😊 Good"
    else: sentiment_label = "🤩 Exceptional"

    st.info(f"Current Rating: **{sentiment_label}** ({feedback_score})")

    if st.button("Submit Feedback", type="primary", help="Help the network learn by rating the response."):
