...
selected_experts = st.multiselect(
    ...
    help="Choose one or more specialized AI agents to process your request. Each expert has unique domain knowledge."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze the network security protocol' or 'Summarize the latest research papers'",
