...
selected_experts = st.multiselect(
    ...
    help="Select one or more specialized AI experts to handle your request."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze the security of this smart contract'",
    help="Type your instruction or question here. Use 'Control+Enter' to submit."
)
