...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Brief pause for user to notice toast
            st.rerun()
        else:
...
selected_experts = st.multiselect(
    ...
    help="Choose one or more specialized expert nodes to process your request."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Explain the concept of Zero-Knowledge Proofs.",
    help="Provide a clear and detailed instruction for the expert network."
)
...
if st.session_state.last_response:
    ...
    if col2.button("Clear Response", type="secondary"):
        st.session_state.last_response = None
        st.rerun()
