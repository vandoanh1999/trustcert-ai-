...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Brief pause to allow the toast to be seen
...
selected_experts = st.multiselect(
    ...
    help="Choosing specific experts allows for more tailored responses. In the full version, the Oracle Brain handles this automatically."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'How can I optimize my local P2P node for better contribution?'",
    help="Be as specific as possible with your instructions to get the best results from the Genesis expert network."
)
