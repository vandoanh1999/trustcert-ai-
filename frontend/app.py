...
selected_experts = st.multiselect(
    ...
    help="Experts are specialized models that provide expertise in different domains. Select one or more to help with your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze the current network health' or 'Explain decentralized P2P routing'",
    help="Type a clear instruction or question for the Genesis network experts to process."
)
...
if st.session_state.last_response:
    ...
    feedback_score = st.slider(
        ...
        0.0, 1.0, 0.75, 0.05,
        help="Your feedback directly influences the reputation and future selection probability of the experts involved."
    )
