...
selected_experts = st.multiselect(
    ...
    help="Experts are specialized models that collaborate to answer your query. In the full system, the Oracle Brain selects these automatically."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., Explain the benefits of decentralized AI in 3 bullet points.",
    help="Be as specific as possible to get the best results from the expert network."
)
