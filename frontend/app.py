...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            st.toast("✨ Success! Feedback submitted.")
...
selected_experts = st.multiselect(
    ...
    help="Choose one or more specialized expert models to handle your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., 'Analyze the recent market trends in decentralized AI.'",
    help="Describe what you want Genesis to do. Be as specific as possible."
)
