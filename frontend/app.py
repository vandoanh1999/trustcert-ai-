...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Small delay to see the toast
            st.rerun()
        else:
...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Explain the benefits of decentralized AI inference...",
    help="Provide a clear, detailed instruction for the Genesis expert network."
)
