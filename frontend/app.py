...
with st.sidebar:
    ...
    if st.button("🗑️ Clear Conversation", help="Reset the current conversation and session state."):
        st.session_state.last_response = None
...
user_instruction = st.text_area(
    ...
    placeholder="e.g., How does the symbiotic feedback loop improve network security?"
)

if st.button(
    "Query Genesis",
    disabled=not user_instruction or not selected_experts,
    help="Send your query to the expert network for processing."
):
