...
user_instruction = st.text_area(
    ...
    placeholder="e.g., Summarize the latest research on symbiotic networks...",
    help="Your query will be routed to the most qualified experts in the Genesis ecosystem."
)
...
if st.session_state.last_response:
    ...
    current_sentiment = next((v for k, v in sorted(sentiment_map.items(), reverse=True) if feedback_score >= k), "☹️ Poor")
