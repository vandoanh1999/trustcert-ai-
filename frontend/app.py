...
def send_feedback_to_backend(dispatch_id, score):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            time.sleep(1) # Allow toast to be visible
            st.rerun()
        else:
...
if st.session_state.last_response:
    st.divider()
    st.header("2. Generated Response & Feedback")
    ...
    feedback_score = st.slider(
        ...
        0.0, 1.0, 0.75, 0.05,
        help="Rate the quality of the generated response."
    )
