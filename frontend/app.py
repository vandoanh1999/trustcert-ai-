...
selected_experts = st.multiselect(
    ...
    help="Choose specific AI experts to handle your query."
)

user_instruction = st.text_area(
    "Enter your instruction or question:",
    placeholder="e.g., How does the reputation system work?",
...
if st.button(
    ...
    type="primary",
    help="Submit your instruction to the decentralized network."
):
